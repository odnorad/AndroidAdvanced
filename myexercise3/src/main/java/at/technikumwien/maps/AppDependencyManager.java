...
public class AppDependencyManager {
    ...
    public DrinkingFountainRepo getDrinkingFountainRepo() {
        //Create an instance and provide it via AppDependencyManager
    ...
    //you get an instance of the created database
    public AppDatabase getDb() {
        if(db == null){
            db = Room.databaseBuilder(appContext, AppDatabase.class, "mapDB").build();
        }
        return db;
    }
}
